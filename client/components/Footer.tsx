...
export default function Footer() {
  const email = () => {
    window.location.href = 'mailto:katiegee@011@gmail.com'
  }
    ...
    <div className="card text-center">
      ...
      <div className="card-body">
        ...
        <div className="icon-container">
          <Link to="https://github.com/KatieRiches" target="_blank">
            <svg
          ...
          <Link
            to="https://www.linkedin.com/in/katie-riches-34b66115b/"
            target="_blank"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
